...
$bantuan_tidak = 121;
    ...
    if ($select_per_atribut) {
        ...
        mysqli_query($koneksi, "update node set jumlah_kasus=" . $jumlah_kasus . ", ya=" . $ya . ", tidak=" . $tidak . ", c1='". $c1 ."', c2='".$c2."' where atribut='".$data_per_atribut['atribut']."' and grup='".$data_per_atribut['grup']."'");
...
while($data = mysqli_fetch_array($select_data)) { // perulangan setiap record dari dataset
    ...
    mysqli_query($koneksi, "INSERT INTO `perhitungan`(`id`, `batas_kategori_c1`, `batas_kategori_c2`, `kategori_taraf_c1`, `kategori_taraf_c2`, `total_c1`, `total_c2`, `klasifikasi`, `kriteria`) VALUES 
    (".$data['id'].",
